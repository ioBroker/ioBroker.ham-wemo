...
gulp.task('rename', function ()  {
    ...
    if (!newname) {
        console.log('Please write the new wemo name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/ham-wemo.png')) {
        fs.renameSync(__dirname + '/admin/ham-wemo.png',              __dirname + '/admin/ham-' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/ham-wemo.html')) {
        fs.renameSync(__dirname + '/widgets/ham-wemo.html',           __dirname + '/widgets/ham-' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/ham-wemo/js/ham-wemo.js')) {
        ...
        fs.renameSync(__dirname + '/widgets/ham-wemo/js/ham-wemo.js', __dirname + '/widgets/ham-' + newname + '/js/ham-' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/ham-wemo')) {
        fs.renameSync(__dirname + '/widgets/ham-wemo',                __dirname + '/widgets/ham-' + newname);
    }
    ...
    const patterns = [
        ...
        {
            match: /Wemo/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Wemo'
        },
        {
            match: /bluefox/g,
            replacement: author
